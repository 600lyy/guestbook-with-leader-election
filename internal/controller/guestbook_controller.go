...
import (
	...
	webappv1 "github.com/600lyy/guestbook-with-leader-election/api/v1"
)

var controllerName = "guestbook-controller"
var logger = log.Log.WithName(controllerName)
var leaseName = "lease-gsc"
...
//+kubebuilder:rbac:groups=webapp.600lyy.io,resources=guestbooks,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=webapp.600lyy.io,resources=guestbooks/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=webapp.600lyy.io,resources=guestbooks/finalizers,verbs=update
//+kubebuilder:rbac:groups=leaderelection.600lyy.io,resources=leases,verbs=get;list;watch;
//+kubebuilder:rbac:groups=leaderelection.600lyy.io,resources=leases/status,verbs=get;
...
func (r *GuestbookReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	logger.Info("reconcling request is from", "obj", req.NamespacedName.Name)
